SWEP.Author 				=	"Corvidus, Improved by d4v3"
SWEP.PrintName				=	"[IMPROVED] Garry's Rocket Jumper"
SWEP.Instructions			=	"Left-Click: Shoot Rocket"

if CLIENT then
	
	SWEP.WepSelectIcon 		=	surface.GetTextureID("vgui/entities/improved_g_rocket_jumper.vtf")
	SWEP.BounceWeaponIcon	=	false
end

SWEP.Slot					=	4
SWEP.SlotPos				=	2
SWEP.Category				=	"Improved Rocket Jumpers"
SWEP.Spawnable				=	true
SWEP.AdminOnly				=	true
